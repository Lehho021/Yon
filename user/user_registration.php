    ...
    <div class="row d-flex align-items-center justify-content-center">
      <div class="lg-12 col-xl-6">
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="mt-4 pt-2">
            <input type="submit" value="Register" class="bg-info text-light py-2 px-3 border-0" name="user_register">
            <p class="small fw-bold mt-2 pt-1 mb-0">Already have an account?
              <a href="user_login.php" class=""> Login</a>
            </p>
          </div>
        </form>
      </div>
...
if(isset($_POST['user_register'])){
    ...
    if($rows_count > 0){
        ...
        move_uploaded_file($user_image_tmp, "./assets/$user_image");
        ...
        if($rows_count > 0){
            ...
            echo "<script>alert('Kamu masih memiliki barang di keranjang');</script>";
